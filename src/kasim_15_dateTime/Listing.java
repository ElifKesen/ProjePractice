...
*/
    ...
    static void listele(ArrayList<User> pakize) {
        if (!pakize.isEmpty()) {
            for (User abuziddin : pakize) { //araylist yerine pakize kullandik
                if (abuziddin.registerDate.getDayOfMonth() <= 10) { //each yerine abuziddin
